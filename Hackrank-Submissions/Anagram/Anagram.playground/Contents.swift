 ...
 **Source:** [Hackerrank - Anagram](https://www.hackerrank.com/challenges/anagram)
 */
...
let input = ["6", "aaabbb", "ab", "abc", "mnop", "xyyx", "xaxbbbxx"] // readArrayOfStrings()
let sampleArray = Array(input[1..<input.count])
